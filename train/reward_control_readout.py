        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                if args.normalize:
                    ...
                    reward_step_loss = F.mse_loss(obs_feat.float(),  torchvision.transforms.functional.resize(labels, (512, 512), interpolation=transforms.InterpolationMode.BILINEAR).float(), reduction="none")
