...
export OUTPUT_DIR="MultiGen_small_tests/0_600_1e-5_readout_cosine_edges_64"


accelerate launch --config_file "train/config.yml" \
 --main_process_port=23866 train/reward_another_control.py \
 ...
 --readout_beta 2 \
 --grad_scale 0 \
 --max_timestep_readout 600 \
 --min_timestep_readout 0 \
 --controlnet_model_name_or_path weights/controlnet \
 --readout_type 'conv' \
 --readout_path '/home/jovyan/konovalova/controlnet_redout/weights/readout_sdv15_spatial_edge.pt'\
 --readout_path_1 '/home/jovyan/konovalova/controlnet_redout/weights/readout_sdv15_spatial_depth.pt'\
