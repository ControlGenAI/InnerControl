    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                #==========================
                with torch.no_grad():
                    # timestep_sampling_start = 200
                    # timestep_sampling_end = timestep_sampling_start+1
                    ...
                    if type(blured_labels) == transformers.modeling_outputs.DepthEstimatorOutput:
                        ...
                        mixed_labels = (timesteps_future.unsqueeze(1).unsqueeze(2) * blured_labels + (1000 - timesteps_future.unsqueeze(1).unsqueeze(2)) * labels) / 1000
