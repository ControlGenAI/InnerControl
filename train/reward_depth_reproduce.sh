...
export OUTPUT_DIR="work_dirs/MultiGen/reward_readout_reproduce_920_random_seed_1"
export HF_HUB_CACHE='/workspace-SR008.fs2/test/datasets'
accelerate launch --config_file "train/config.yml" \
 --main_process_port=23256 train/reward_control_readout.py \
...
export CONTROLNET_DIR="work_dirs/MultiGen/reward_readout_reproduce_920_random_seed_1/checkpoint-10000/controlnet"  # Eval our ControlNet++
