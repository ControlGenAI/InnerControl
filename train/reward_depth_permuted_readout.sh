...
export OUTPUT_DIR="MultiGen_small_tests/0_600_1e-5_readout_readout_trained_400_steps_2_0_control_x3"


accelerate launch --config_file "train/config.yml" \
 --main_process_port=23766 train/reward_control_readout_train.py \
