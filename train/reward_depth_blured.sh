...
export OUTPUT_DIR="work_dirs/MultiGen/reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_first_timesteps"
export HF_HUB_CACHE='/workspace-SR008.fs2/test/datasets'
accelerate launch --config_file "train/config.yml" \
 --main_process_port=23156 train/reward_control_noisy_fix_diff.py \
 ...
 --resume_from_checkpoint 'work_dirs/MultiGen/reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_first_timesteps/checkpoint-1000'


export CONTROLNET_DIR="work_dirs/MultiGen/reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_first_timesteps/checkpoint-10000/controlnet"  # Eval our ControlNet++
