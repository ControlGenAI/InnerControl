export CONTROLNET_DIR="MultiGen/reward_controlnet_sd15_depth_res512_bs256_lr1e-5_warmup100_scale-1.0_iter10k_fp16_train0-1k_reward0-200_mse-loss_new_scale_seed_42_reward_only_920_steps/checkpoint-10000/controlnet"  # Eval our ControlNet++
