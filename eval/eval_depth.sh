...
# export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/lllyasviel_control_v11f1p_sd15_depth_7.5-20/images/'
# python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_reward_model_MultiGen_controlnet_tuning_checkpoint-10000_controlnet_7.5-20/'
# python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# # origin controlnet
# export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/lllyasviel_control_v11f1p_sd15_depth_7.5-20/'
# python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# # reward new start
# export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_reproduce_another_starts_checkpoint-10000_controlnet_7.5-20/'
# python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward-readout
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_reproduce_920_checkpoint-10000_controlnet_7.5-20'
python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward readout random seed
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_reproduce_920_random_seed_checkpoint-10000_controlnet_7.5-20/'
python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward fix diff 200
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_blured_200_920_42_control_fix_diff_interpolated_checkpoint-10000_controlnet_7.5-20/'
python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward fix diff 200 init steps
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_readout_first_timesteps_checkpoint-10000_controlnet_7.5-20/'
python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward readout fix diff 200
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_readout_checkpoint-10000_controlnet_7.5-20/'
python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# reward freadout fix diff 200 init steps
export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/work_dirs_MultiGen_reward_readout_blured_200_920_42_control_fix_diff_interpolated_200_first_timesteps_checkpoint-10000_controlnet_7.5-20/'
...
# export DATA_DIR='work_dirs/reproduce/MultiGen-20M_depth_eval/validation/_workspace-SR008.fs2_test_controlnet_redout_work_dirs_MultiGen_reward_readout_920_seed_3407_checkpoint-10000_controlnet_7.5-20'
# python3 eval/eval_depth.py --root_dir ${DATA_DIR}

# export CONTROLNET_DIR="work_dirs/MultiGen/reward_readout_920_3407/checkpoint-10000/controlnet"  # Eval our ControlNet++
# # How many PUs and processes you want to use for evaluation.
# export NUM_GPUS=8
# # Guidance scale and inference steps
# export SCALE=7.5
...
# export CONTROLNET_DIR="work_dirs/MultiGen/reward_readout_blured_200_920_42_control_fix_diff/checkpoint-10000/controlnet"  # Eval our ControlNet++
# # How many PUs and processes you want to use for evaluation.
# export NUM_GPUS=8
# # Guidance scale and inference steps
# export SCALE=7.5
